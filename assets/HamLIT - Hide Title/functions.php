...
<style type="text/css"> body.LIT-hide-title .entry-title { display:none !important; }</style>
<!-- END HamLIT Hide Title -->

			<?php 
									
				add_filter( 'body_class', function( $classes ) {
					return array_merge( $classes, array( 'LIT-hide-title' ) );
				} );						
    ...
    $HamLITHideTitle = new HamLITHideTitle;

} // !class_exists( 'HamLITHideTitle' )